...
output/local_resume.html: output/local_css.pd james_williams_resume.md assets/download_links.pd assets/html5.pd
	pandoc --template=assets/html5.pd --include-in-header=output/local_css.pd --include-after-body=assets/download_links.pd --write=html5 --standalone --smart -o output/local_resume.html james_williams_resume.md

output/index.html: output/remote_css.pd james_williams_resume.md assets/download_links.pd assets/html5.pd assets/script_header.pd
	pandoc --template=assets/html5.pd --include-in-header=output/remote_css.pd --include-in-header=assets/script_header.pd --include-after-body=assets/download_links.pd --write=html5 --standalone --smart -o output/index.html james_williams_resume.md
