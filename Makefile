...
output/local_css.pd: output assets/resume_css.pd
...
output/remote_css.pd: output assets/resume_css.pd
...
output/local_resume.html: output output/local_css.pd james_williams_resume.md assets/download_links.pd assets/html_comments.pd assets/html5.pd
...
output/index.html: output output/remote_css.pd james_williams_resume.md assets/download_links.pd assets/html_comments.pd assets/html5.pd assets/script_header.pd
...
output/james_williams_resume.pdf: output output/local_resume.html
	wkhtmltopdf --title "Resume of James Williams" --print-media-type output/local_resume.html output/james_williams_resume.pdf

output/james_williams_resume.txt: output james_williams_resume.md
...
output/james_williams_resume.docx: output james_williams_resume.md
